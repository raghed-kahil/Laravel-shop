        ...
        <div class="container"><a href="/" class="navbar-brand home"><img src="/img/logo.png" alt="Obaju logo" class="d-none d-md-inline-block"><img src="/img/logo-small.png" alt="Obaju logo" class="d-inline-block d-md-none"><span class="sr-only">Obaju - go to homepage</span></a>
            ...
            <div id="navigation" class="collapse navbar-collapse">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-3">
                                        ...
                                        <ul class="list-unstyled mb-3">
                                            <li class="nav-item"><a href="/products" class="nav-link">T-shirts</a></li>
                                            <li class="nav-item"><a href="/products" class="nav-link">Shirts</a></li>
                                            <li class="nav-item"><a href="/products" class="nav-link">Pants</a></li>
                                            <li class="nav-item"><a href="/products" class="nav-link">Accessories</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6 col-lg-3">
                                        <h5>Shoes</h5>
                                        <ul class="list-unstyled mb-3">
                                            <li class="nav-item"><a href="/products" class="nav-link">Trainers</a></li>
                                            <li class="nav-item"><a href="/products" class="nav-link">Sandals</a></li>
                                            <li class="nav-item"><a href="/products" class="nav-link">Hiking shoes</a></li>
                                            <li class="nav-item"><a href="/products" class="nav-link">Casual</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6 col-lg-3">
                                        <h5>Accessories</h5>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-3">
                                        ...
                                        <ul class="list-unstyled mb-3">
                                            ...
                                            <li class="nav-item"><a href="/products" class="nav-link">Products - sidebar left</a></li>
                                            <li class="nav-item"><a href="/products-right" class="nav-link">Products - sidebar right</a></li>
                                            <li class="nav-item"><a href="/products-full" class="nav-link">Products - full width</a></li>
                                            <li class="nav-item"><a href="/products/1" class="nav-link">Product detail</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6 col-lg-3">
                                        <h5>User</h5>
                ...
                <div class="navbar-buttons d-flex justify-content-end">
                    ...
                    <div id="basket-overview" class="navbar-collapse collapse d-none d-lg-block"><a href="/basket" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span id="basket-button">{{Cookie::get('basket-count',0)}} items in cart</span></a></div>
                </div>
            </div>
        </div>
    </nav>
