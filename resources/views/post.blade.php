              ...
              <div class="card sidebar-menu mb-4">
                ...
                <div class="card-body">
                  <ul class="nav flex-column nav-pills">
                    <li><a href="blog" class="nav-link">About us</a></li>
                    <li><a href="blog" class="nav-link active">Fashion</a></li>
                    <li><a href="blog" class="nav-link">News and gossip</a></li>
                    <li><a href="blog" class="nav-link">Design</a></li>
                  </ul>
                </div>
              </div>
              <!-- /.col-lg-3-->
